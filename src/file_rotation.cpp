...
public:
    ...
    static std::string get_rotated_log_path(const FileSinkConfig& config, int rotation_number) {
    ...
    static std::vector<std::string> get_rotated_files_sorted(const FileSinkConfig& config) {
